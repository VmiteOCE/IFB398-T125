...
describe('PUT /games/update/:id', () => {
    ...
    test('updates an existing game', async () => {
        ...
        expect(String(response.body.game_id))
            .toBe(String(gameId));
...
describe('GET /games filters', () => {
    ...
    test('filters games on or after the start date', async () => {
        const response = await request(app)
            .get('/games?start=2026-08-15T00:00');
    ...
    test('filters games between start and end dates', async () => {
        const response = await request(app)
            .get(
                '/games?start=2026-08-11T00:00&end=2026-08-19T23:59'
            );
    ...
    test('sorts games by start time ascending', async () => {
        const response = await request(app)
            .get('/games?sortBy=start_time&sortOrder=asc');
    ...
    test('sorts games by start time descending', async () => {
        const response = await request(app)
            .get('/games?sortBy=start_time&sortOrder=desc');
    ...
    const response = await request(app)
        .get('/games?page=1&limit=2&sortBy=start_time&sortOrder=asc');
    ...
    test('returns the second page correctly', async () => {
        const response = await request(app)
            .get('/games?page=2&limit=2&sortBy=start_time&sortOrder=asc');
